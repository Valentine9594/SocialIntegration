...
//        }
    ...
    func linkedInAuthVC() {
        ...
        @objc func refreshAction() {
            (presentingViewController as? ViewController)?.webView.reload()
        }
    
    
    
    
    static let shared = LinkedInIntegration()
    
    func callLinkedInWebView(){
        self.linkedInAuthVC()
    }
...
extension LinkedInIntegration: WKNavigationDelegate {
